...
module.exports.examGet = async(req,res,next)=>{
    ...
    if (!errors.isEmpty()) {
        ...
        res.status(422).render('exam/examCategory',{
            ...
            breadcrumbs,
            //seo
            title: `Demo: validation error`,
            description: `You can test onlinepgdexam.com's exam system.  ` ,
    ...
    if(questionCategoryId){
        ...
        if(questionList.length >0){                
            return res.status(200).render('exam/examSheet',{
                ...
                breadcrumbs,
                //seo
                title: `Demo: Exam questions for Demonstration purpose for post graduation medical student`,
                description: `You can test onlinepgdexam.com's exam system.  ` ,
                keywords: 'online, medical, post graduation, residency, fcps, frcs, MD, MS, Exam'
            });
        } else{
            return res.status(200).render('exam/examCategory',{
                ...
                breadcrumbs,
                //seo
                title: `Demo: No Exam questions for Demonstration is created for post graduation medical student`,
                description: `You can test onlinepgdexam.com's exam system.  ` ,
                keywords: 'online, medical, post graduation, residency, fcps, frcs, MD, MS, Exam'
            });
        }
